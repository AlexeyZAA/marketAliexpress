...
class UserController extends \yii\web\Controller
{
    ...
    {   
        /*Перенаправляем не зарегеного юзера на домашнюю */
        if (!Yii::$app->user->isGuest) {
            return Yii::$app->response->redirect(['/', 'id' => $id]);
        }
    ...
    /*
     * Экшн для вьюхи профиля админа
     */
    public function actionProfileadm()
    {
        $model = Yii::$app->user->identity;
        $changePasswordForm = new ChangePasswordForm;
        $changeEmailForm = new ChangeEmailForm;
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->redirect(Url::toRoute('/user/user/profileadm'));
        }
        ...
        return $this->render($this->module->getCustomView('profileadm'), [
            'model' => $model,
            'changePasswordForm' => $changePasswordForm,
            'changeEmailForm' => $changeEmailForm
          ]);
 ...
 */
     public function actionProfileuser()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->redirect(Url::toRoute('/user/user/profileuser'));
        }
        ...
        return $this->render($this->module->getCustomView('profileuser'), [
            'model' => $model,
            'changePasswordForm' => $changePasswordForm,
            'changeEmailForm' => $changeEmailForm
          ]);
